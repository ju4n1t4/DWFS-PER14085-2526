...
function greyConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      ...
      const media = Math.floor((r + g + b) / 3);
...
function blackAndWhiteConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      ...
      const media = Math.floor((r + g + b) / 3);
      const mediaValidation = media < 128 ? 0 : 255;

      pixels[i][j][0] = mediaValidation;
      pixels[i][j][1] = mediaValidation;
      pixels[i][j][2] = mediaValidation;
    }
  }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      let r =
        Math.floor(catPixels[i][j][0] * alphaFirst) +
        Math.floor(dogPixels[i][j][0] * alphaSecond);
      let g =
        Math.floor(catPixels[i][j][1] * alphaFirst) +
        Math.floor(dogPixels[i][j][1] * alphaSecond);
      let b =
        Math.floor(catPixels[i][j][2] * alphaFirst) +
        Math.floor(dogPixels[i][j][2] * alphaSecond);
