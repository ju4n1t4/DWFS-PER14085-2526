  ...
  let pixels = [];
    ...
    for(let i=0; i < catPixels.length; i++) {
        ...
        for(let j=0; j < catPixels[i].length; j++) {
            let newPixel = [];
            newPixel[0] = catPixels[i][j][0]*alphaFirst + dogPixels[i][j][0]*alphaSecond;
            newPixel[1] = catPixels[i][j][1]*alphaFirst + dogPixels[i][j][1]*alphaSecond;
            newPixel[2] = catPixels[i][j][2]*alphaFirst + dogPixels[i][j][2]*alphaSecond;
