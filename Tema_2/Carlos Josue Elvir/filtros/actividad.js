...
function greyConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    ...
    for (let j = 0; j < fila.length; j++) {
      let columna = fila[j]
      let media = ((columna[0] + columna[1] + columna[2]) / 3)
      columna[0] = media;
      columna[1] = media;
      columna[2] = media;
    }
...
function invertColors() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    ...
    for (let j = 0; j < fila.length; j++) {
      let columna = fila[j]
      columna[0] = 255 - columna[0];
      columna[1] = 255 - columna[1];
      columna[2] = 255 - columna[2];
      columna[3] = 255 - columna[3];
    }
  }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      ...
      let r = (catPixel[0] * alphaFirst + dogPixel[0] * alphaSecond);
      let g = (catPixel[1] * alphaFirst + dogPixel[1] * alphaSecond);
      let b = (catPixel[2] * alphaFirst + dogPixel[2] * alphaSecond);
      let a = (catPixel[3] * alphaFirst + dogPixel[3] * alphaSecond);
