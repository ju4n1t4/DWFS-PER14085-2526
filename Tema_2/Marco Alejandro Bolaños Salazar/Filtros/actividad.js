...
function redConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      pixels[i][j][1] = 0; // Canal G
      pixels[i][j][2] = 0; // Canal B
    }
  }
...
function greyConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      let promedio = 0;
      for (let k = 0; k < 3; k++) {
        promedio += pixels[i][j][k];
      }
      promedio = Math.round(promedio / 3);
      for (let k = 0; k < 3; k++) {
        pixels[i][j][k] = promedio;
      }
    }
  }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    for (let j = 0; j < catPixels[i].length; j++) {
      for (let k = 0; k < 3; k++) {
        catPixels[i][j][k] = catPixels[i][j][k] * alphaSecond;
      }
    }
  }
  pixels = catPixels.slice();

  for (let i = 0; i < dogPixels.length; i++) {
    for (let j = 0; j < dogPixels[i].length; j++) {
      for (let k = 0; k < 3; k++) {
        dogPixels[i][j][k] = dogPixels[i][j][k] * alphaFirst;
      }
    }
  }
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      for (let k = 0; k < 3; k++) {
        pixels[i][j][k] = pixels[i][j][k] + dogPixels[i][j][k];
      }
    }
  }
