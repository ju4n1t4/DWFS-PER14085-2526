...
function dimBrightness(dimFactor) {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      pixels[i][j] = [pixels[i][j][0] / dimFactor, pixels[i][j][1] / dimFactor, pixels[i][j][2] / dimFactor];
    }
  }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      pixels[i][j] = [catPixels[i][j][0] * alphaFirst + dogPixels[i][j][0] * alphaSecond, catPixels[i][j][1] * alphaFirst + dogPixels[i][j][1] * alphaSecond, catPixels[i][j][2] * alphaFirst + dogPixels[i][j][2] * alphaSecond];
    }
  }
