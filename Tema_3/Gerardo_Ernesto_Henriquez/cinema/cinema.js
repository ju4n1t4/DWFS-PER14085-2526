...
document.getElementById('confirmBtn').addEventListener('click', () => {
    const seatCount = Number.parseInt(document.getElementById('seatCount').value, 10);
    if (Number.isInteger(seatCount) && seatCount > 0) {
...
document.getElementById('seatCount').value = asientosSolicitados;
mostrarSugerencia(asientosSolicitados);