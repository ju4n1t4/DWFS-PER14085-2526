...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    // Comprobar si hay mensajes de error (solo los mensajes con la clase "error" dentro de #userForm)
    let errorMessages = document.querySelectorAll('#userForm p.error');
